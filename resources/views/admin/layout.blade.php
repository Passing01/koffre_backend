            ...
            <div class="absolute bottom-0 w-64 p-4 border-t border-gray-700">
                <div class="px-4 py-3 mb-2">
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="font-semibold text-sm">{{ auth()->user()->fullname ?? 'Admin' }}</p>
                ...
                <form method="POST" action="{{ route('admin.logout') }}">
                    @csrf
                    <button type="submit"
                        class="w-full px-4 py-2 bg-red-600 hover:bg-red-700 rounded-lg transition-all text-sm font-medium">
